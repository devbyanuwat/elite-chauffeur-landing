 ...
 *   พ.ร.บ. ครบทุกคัน .......... src/components/sections/Why.astro
...
export const PRODUCTS: ProductItem[] = [
  {
    ...
    a: 'คนขับคนเดิมอยู่กับคุณทั้งทริป รอได้ ไปต่อได้ ไม่ต้องเรียกรถใหม่ทุกจุด รถทุกคันมี พ.ร.บ. ครบ คนขับผ่านการคัดประวัติก่อนรับงาน ราคาตกลงกันตั้งแต่ก่อนออกรถ ไม่มีมิเตอร์ ไม่มีบวกเพิ่มตอนรถติด',
  ...
  },
  {
    ...
    a: 'รับงานรับส่งผู้บริหาร รับส่งแขกของบริษัท และงานที่ต้องใช้รถซ้ำเป็นรอบ ใช้รถและคนขับชุดเดียวกับงานทั่วไป คือมี พ.ร.บ. ครบและผ่านการคัดประวัติมาแล้ว บอกจำนวนรอบและเส้นทางมา เราคิดราคาให้ก่อนเริ่มงาน ไม่มีบวกเพิ่มหน้างาน',
